<template><div><h1 id="vue-常用的修饰符有哪些-有什么应用场景" tabindex="-1"><a class="header-anchor" href="#vue-常用的修饰符有哪些-有什么应用场景"><span>Vue 常用的修饰符有哪些？有什么应用场景？</span></a></h1>
<nav class="table-of-contents"><ul><li><router-link to="#修饰符是什么在程序世界里-修饰符是用于限定类型以及类型成员的声明的一种符号">修饰符是什么在程序世界里，修饰符是用于限定类型以及类型成员的声明的一种符号</router-link></li><li><router-link to="#修饰符的作用">修饰符的作用</router-link><ul><li><router-link to="#表单修饰符">表单修饰符</router-link></li><li><router-link to="#事件修饰符">事件修饰符</router-link></li><li><router-link to="#鼠标按钮修饰符">鼠标按钮修饰符</router-link></li><li><router-link to="#键盘修饰符">键盘修饰符</router-link></li><li><router-link to="#v-bind-修饰符">v-bind 修饰符</router-link></li></ul></li><li><router-link to="#应用场景">应用场景</router-link></li><li><router-link to="#参考文献">参考文献</router-link></li></ul></nav>
<h2 id="修饰符是什么在程序世界里-修饰符是用于限定类型以及类型成员的声明的一种符号" tabindex="-1"><a class="header-anchor" href="#修饰符是什么在程序世界里-修饰符是用于限定类型以及类型成员的声明的一种符号"><span>修饰符是什么在程序世界里，修饰符是用于限定类型以及类型成员的声明的一种符号</span></a></h2>
<p>在 Vue 中，修饰符处理了许多 DOM 事件的细节，让我们不再需要花大量的时间去处理这些烦恼的事情，而能有更多的精力专注于程序的逻辑处理</p>
<p>vue 中修饰符分为以下五种：</p>
<ul>
<li>表单修饰符</li>
<li>事件修饰符</li>
...
<h2 id="修饰符的作用" tabindex="-1"><a class="header-anchor" href="#修饰符的作用"><span>修饰符的作用</span></a></h2>
<h3 id="表单修饰符" tabindex="-1"><a class="header-anchor" href="#表单修饰符"><span>表单修饰符</span></a></h3>
<p>在我们填写表单的时候用得最多的是 input 标签，指令用得最多的是 v-model</p>
<p>关于表单的修饰符有如下：</p>
<ul>
<li>
<p>lazy</p>
<p>在我们填完信息，光标离开标签的时候，才会将值赋予给 value，也就是在 change 事件之后再进行信息同步</p>
...
<li>
<p>number</p>
<p>自动将用户的输入值转为数值类型，但如果这个值无法被 parseFloat 解析，则会返回原来的值</p>
...
<li>
<p>stop</p>
<p>阻止了事件冒泡，相当于调用了 event.stopPropagation 方法</p>
<div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code>div @click<span class="token operator">=</span><span class="token string">"shout(2)"</span><span class="token operator">></span>
...
<li>
<p>prevent</p>
<p>阻止了事件的默认行为，相当于调用了 event.preventDefault 方法</p>
...
<div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token operator">&lt;</span>div @click<span class="token punctuation">.</span>capture<span class="token operator">=</span><span class="token string">"shout(1)"</span><span class="token operator">></span>
  obj1
...
<li>
<p>passive</p>
<p>在移动端，当我们在监听元素滚动事件的时候，会一直触发 onscroll 事件会让我们的网页变卡，因此我们使用这个修饰符的时候，相当于给 onscroll 事件整了一个.lazy 修饰符</p>
<div class="language-html line-numbers-mode" data-ext="html" data-title="html"><pre v-pre class="language-html"><code><span class="token comment">&lt;!-- 滚动事件的默认行为 (即滚动行为) 将会立即触发 --></span>
...
<p>不要把 .passive 和 .prevent 一起使用,因为 .prevent 将会被忽略，同时浏览器可能会向你展示一个警告。
passive 会告诉浏览器你不想阻止事件的默认行为</p>
</blockquote>
</li>
<li>
<p>native</p>
<p>让组件变成像 html 内置标签那样监听根元素的原生事件，否则组件上使用 v-on 只会监听自定义事件</p>
...
<p>注意：使用.native 修饰符来操作普通 HTML 标签是会令事件失效的</p>
</blockquote>
</li>
</ul>
<h3 id="鼠标按钮修饰符" tabindex="-1"><a class="header-anchor" href="#鼠标按钮修饰符"><span>鼠标按钮修饰符</span></a></h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="键盘修饰符" tabindex="-1"><a class="header-anchor" href="#键盘修饰符"><span>键盘修饰符</span></a></h3>
<p>键盘修饰符是用来修饰键盘事件（onkeyup，onkeydown）的，有如下：</p>
<p>keyCode 存在很多，但 vue 为我们提供了别名，分为以下两种：</p>
<ul>
<li>普通键（enter、tab、delete、space、esc、up...）</li>
<li>系统修饰键（ctrl、alt、meta、shift...）</li>
</ul>
<div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 只有按键为keyCode的时候才触发</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>还可以通过以下方式自定义一些全局的键盘码别名</p>
<div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code>Vue<span class="token punctuation">.</span>config<span class="token punctuation">.</span>keyCodes<span class="token punctuation">.</span>f2 <span class="token operator">=</span> <span class="token number">113</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="v-bind-修饰符" tabindex="-1"><a class="header-anchor" href="#v-bind-修饰符"><span>v-bind 修饰符</span></a></h3>
<p>v-bind 修饰符主要是为属性进行操作，用来分别有如下：</p>
<ul>
<li>
<p>async</p>
<p>能对 props 进行一个双向绑定</p>
<div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token comment">//父组件</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>以上这种方法相当于以下的简写</p>
<div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token comment">//父亲组件</span>
...
<span class="token function">func2</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
  <span class="token keyword">this</span><span class="token punctuation">.</span><span class="token function">$emit</span><span class="token punctuation">(</span><span class="token string">'update:myMessage'</span><span class="token punctuation">,</span>params<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>使用async需要注意以下两点：</p>
<ul>
<li>
<p>使用sync的时候，子组件传递的事件名格式必须为update:value，其中value必须与子组件中props中声明的名称完全一致</p>
</li>
<li>
<p>注意带有 .sync 修饰符的 v-bind 不能和表达式一起使用</p>
</li>
<li>
<p>将 v-bind.sync 用在一个字面量的对象上，例如 v-bind.sync=”{ title: doc.title }”，是无法正常工作的</p>
</li>
</ul>
</li>
<li>
<p>prop</p>
<p>设置自定义标签属性，避免暴露数据，防止污染HTML结构</p>
...
<li>
<p>camel</p>
<p>将命名变为驼峰命名法，如将view-Box属性名转换为 viewBox</p>
...
<ul>
<li><a href="https://segmentfault.com/a/1190000016786254" target="_blank" rel="noopener noreferrer">https://segmentfault.com/a/1190000016786254<ExternalLinkIcon/></a></li>
