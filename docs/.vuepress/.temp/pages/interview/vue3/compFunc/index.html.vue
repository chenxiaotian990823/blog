<template><div><h1 id="组合函数" tabindex="-1"><a class="header-anchor" href="#组合函数"><span>组合函数</span></a></h1>
<nav class="table-of-contents"><ul><li><router-link to="#例子">例子</router-link><ul><li><router-link to="#解释">解释</router-link></li><li><router-link to="#onmounted-和-onunmounted-不是-vue-的生命周期吗-为嘛可以用到这里">onMounted 和 onUnmounted 不是 vue 的生命周期吗？为嘛可以用到这里</router-link></li></ul></li><li><router-link to="#其他例子">其他例子</router-link></li><li><router-link to="#我如果要做一个图片懒加载-需要怎么做">我如果要做一个图片懒加载，需要怎么做</router-link><ul><li><router-link to="#题外话-可以用自定义指令实现懒加载吗">题外话，可以用自定义指令实现懒加载吗？</router-link></li></ul></li><li><router-link to="#那这些组合复用函数-一般放在哪个目录下呢">那这些组合复用函数，一般放在哪个目录下呢</router-link></li></ul></nav>
<h2 id="例子" tabindex="-1"><a class="header-anchor" href="#例子"><span>例子</span></a></h2>
<div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> ref<span class="token punctuation">,</span> onMounted<span class="token punctuation">,</span> onUnmounted <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">"vue"</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="解释" tabindex="-1"><a class="header-anchor" href="#解释"><span>解释</span></a></h3>
<p>1.导入部分:</p>
<ul>
<li>
<p>ref 用于定义响应式的数据。</p>
...
<li>
<p>onMounted 和 onUnmounted 用于在组件挂载和卸载时执行相应的逻辑。</p>
<p>2.响应式数据:</p>
</li>
<li>
<p>使用 ref 定义了两个响应式变量 x 和 y，分别用来存储鼠标的横坐标和纵坐标。</p>
<p>3.事件处理函数:</p>
</li>
<li>
<p>update 函数会在 mousemove 事件触发时更新 x 和 y 的值。</p>
<p>4.生命周期钩子:</p>
</li>
<li>
<p>在 onMounted 钩子中，添加了 mousemove 事件监听器。</p>
</li>
<li>
<p>在 onUnmounted 钩子中，移除了 mousemove 事件监听器。</p>
</li>
</ul>
<h3 id="onmounted-和-onunmounted-不是-vue-的生命周期吗-为嘛可以用到这里" tabindex="-1"><a class="header-anchor" href="#onmounted-和-onunmounted-不是-vue-的生命周期吗-为嘛可以用到这里"><span>onMounted 和 onUnmounted 不是 vue 的生命周期吗？为嘛可以用到这里</span></a></h3>
<p>在 Vue 3 中，onMounted 和 onUnmounted 是组合式 API 的生命周期钩子函数，可以在任何组合函数（如你的 useMouse 函数）中使用，而不仅仅是组件中。这是因为组合式 API 允许你将与组件生命周期相关的逻辑封装到可复用的函数中。</p>
<p>在组合式 API 中使用生命周期钩子的方式如下：</p>
<div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> ref<span class="token punctuation">,</span> onMounted<span class="token punctuation">,</span> onUnmounted <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">"vue"</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> useMouse
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>为什么可以在组合函数中使用生命周期钩子？</p>
<p>在 Vue 3 中，组合函数（或称作组合式 API 函数）可以封装与生命周期相关的逻辑，这是其强大之处之一。组合函数不直接依赖组件上下文，而是依赖 Vue 的响应式系统和生命周期管理。</p>
<p>使用组合函数的好处:</p>
<p>1.代码复用：可以将相同的逻辑抽象成函数，在多个组件中复用。</p>
<p>2.逻辑组织：将组件逻辑按功能模块化，增强代码的可读性和维护性。</p>
<p>3.灵活性：可以在任何需要的地方使用这些函数，而不仅限于组件内部。</p>
<p>所以，在你的 useMouse 函数中使用 onMounted 和 onUnmounted 是完全正确的做法。这使得你的鼠标跟踪逻辑能够被多个组件复用，并且能够正确处理组件的生命周期事件。</p>
<h2 id="其他例子" tabindex="-1"><a class="header-anchor" href="#其他例子"><span>其他例子</span></a></h2>
<ol>
<li>使用窗口大小的组合函数</li>
</ol>
<p>这是一个跟踪窗口大小变化的例子：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="我如果要做一个图片懒加载-需要怎么做" tabindex="-1"><a class="header-anchor" href="#我如果要做一个图片懒加载-需要怎么做"><span>我如果要做一个图片懒加载，需要怎么做</span></a></h2>
<p>图片懒加载是一种延迟加载图片的技术，仅在图片进入视口（用户可见区域）时才加载图片，以提高页面性能和用户体验。你可以使用 Vue 3 的组合式 API 和 Intersection Observer API 来实现图片懒加载功能。以下是一个完整的实现示例。</p>
<ol>
<li>创建懒加载组合函数</li>
</ol>
<p>首先，创建一个组合函数来封装懒加载的逻辑：</p>
<div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> ref<span class="token punctuation">,</span> onMounted<span class="token punctuation">,</span> onUnmounted <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">"vue"</span>
...
<p>创建一个组件来使用 useLazyLoad 组合函数，实现图片的懒加载：</p>
<div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token operator">&lt;</span>template<span class="token operator">></span>
  <span class="token operator">&lt;</span>div<span class="token operator">></span>
...
<ul>
<li>useLazyLoad 组合函数：</li>
</ul>
<p>imageRef 是一个 ref，指向要懒加载的图片元素。
isIntersecting 是一个响应式状态，用于指示图片是否进入视口。
使用 IntersectionObserver 观察图片元素是否进入视口。如果进入视口，则设置 isIntersecting 为 true 并停止观察该元素。</p>
<ul>
<li>组件 LazyImage：</li>
</ul>
<p>imageRef 绑定到图片或占位符 div 上。
当 isIntersecting 为 true 时，渲染图片；否则渲染占位符 div。</p>
<ul>
<li>使用组件：</li>
</ul>
<p>在主应用中使用 LazyImage 组件，并传递图片的 src 属性。</p>
<h3 id="题外话-可以用自定义指令实现懒加载吗" tabindex="-1"><a class="header-anchor" href="#题外话-可以用自定义指令实现懒加载吗"><span>题外话，可以用自定义指令实现懒加载吗？</span></a></h3>
<p>Vue 3 中，你可以使用自定义指令来实现图片懒加载。自定义指令提供了一种直接操作 DOM 元素的方式，非常适合用于这种场景。以下是如何使用自定义指令实现图片懒加载的步骤。</p>
<ol>
<li>创建自定义指令</li>
</ol>
<p>首先，我们创建一个自定义指令 v-lazy 来实现图片懒加载。</p>
<div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> ref <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">"vue"</span>
...
<li>在 Vue 应用中注册自定义指令</li>
</ol>
<p>你可以在主应用中注册这个自定义指令：</p>
<div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> createApp <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">"vue"</span>
...
<li>指令定义对象：
<ul>
<li>mounted：当绑定元素插入到 DOM 中时调用。在这里，我们使用 IntersectionObserver 来观察元素是否进入视口。</li>
<li>绑定值：通过 binding.value 获取传递给指令的图片 URL。</li>
<li>IntersectionObserver：当图片元素进入视口时，设置图片的 src 属性，并停止观察该元素。</li>
</ul>
</li>
</ul>
<h2 id="那这些组合复用函数-一般放在哪个目录下呢" tabindex="-1"><a class="header-anchor" href="#那这些组合复用函数-一般放在哪个目录下呢"><span>那这些组合复用函数，一般放在哪个目录下呢</span></a></h2>
<p>在 Vue 3 项目中，组合函数（也称为 composables 或 hooks）通常放在一个专门的目录中，以便于管理和复用。以下是一些常见的目录结构建议，以及如何组织这些组合函数。</p>
<ol>
<li>建议的目录结构</li>
</ol>
<p>通常，在 Vue 项目中，你可以创建一个 composables 或 hooks 目录来存放这些组合函数：</p>
<div class="language-css line-numbers-mode" data-ext="css" data-title="css"><pre v-pre class="language-css"><code>src/
├── assets/
├── components/
├── composables/  # 或 hooks/
│   ├── useMouse.js
...
<p>创建一个 composables 目录，并在其中创建各个组合函数文件。例如：</p>
<p>useMouse.js</p>
<div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> ref<span class="token punctuation">,</span> onMounted<span class="token punctuation">,</span> onUnmounted <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">"vue"</span>
...
<p>你可以在你的 Vue 组件中导入和使用这些组合函数。例如：</p>
<div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token operator">&lt;</span>template<span class="token operator">></span>
  <span class="token operator">&lt;</span>div<span class="token operator">></span>
    <span class="token operator">&lt;</span>p<span class="token operator">></span>Mouse position<span class="token operator">:</span> <span class="token punctuation">{</span><span class="token punctuation">{</span> x <span class="token punctuation">}</span><span class="token punctuation">}</span><span class="token punctuation">,</span> <span class="token punctuation">{</span><span class="token punctuation">{</span> y <span class="token punctuation">}</span><span class="token punctuation">}</span><span class="token operator">&lt;</span><span class="token operator">/</span>p<span class="token operator">></span>
    <span class="token operator">&lt;</span>p<span class="token operator">></span>Window size<span class="token operator">:</span> <span class="token punctuation">{</span><span class="token punctuation">{</span> width <span class="token punctuation">}</span><span class="token punctuation">}</span> x <span class="token punctuation">{</span><span class="token punctuation">{</span> height <span class="token punctuation">}</span><span class="token punctuation">}</span><span class="token operator">&lt;</span><span class="token operator">/</span>p<span class="token operator">></span>
